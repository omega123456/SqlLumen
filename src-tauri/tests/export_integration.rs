    ...
    state.result_cache.insert(
        ...
        vec![
            StoredResult {
                ...
                rows: std::sync::Arc::new(vec![vec![serde_json::json!(10)]]),
                execution_time_ms: 1,
                affected_rows: 0,
            ...
            StoredResult {
                ...
                rows: std::sync::Arc::new(vec![vec![serde_json::json!(20)]]),
                execution_time_ms: 2,
                affected_rows: 0,
                auto_limit_applied: false,
            },
...
fn test_export_results_impl_sql_default_table_name() {
    ...
    state.result_cache.insert(
        ...
        vec![StoredResult {
            ...
            rows: std::sync::Arc::new(vec![vec![serde_json::json!(42)]]),
            execution_time_ms: 1,
            affected_rows: 0,
            auto_limit_applied: false,
        }],
...
fn test_export_results_impl_with_row_indices_out_of_bounds_skipped() {
    ...
    state.result_cache.insert(
        ...
        vec![StoredResult {
            ...
            rows: std::sync::Arc::new(vec![vec![serde_json::json!(1)], vec![serde_json::json!(2)]]),
            execution_time_ms: 1,
            affected_rows: 0,
            auto_limit_applied: false,
        }],
